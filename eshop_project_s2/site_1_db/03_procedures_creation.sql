...
BEGIN
    ...
    SELECT COUNT(*) INTO nc FROM LIGNES_COMMANDES_1 WHERE ID_LIGNE_COMMANDE = p_id_ligne_commande;
    IF nc > 0 THEN
    ...
    -- 5. Insert
    INSERT INTO LIGNES_COMMANDES_1 (ID_LIGNE_COMMANDE, ID_COMMANDE, ID_PRODUIT, QUANTITE, REMISE)
...
AS
    v_id_commande LIGNES_COMMANDES_1.ID_COMMANDE%TYPE;
...
BEGIN
    ...
    -- 3. Check if there are other lines left for this command in Site 1
    ...
    IF v_count_lines = 0 THEN
        ...
        -- 5. If this client has no other commands left in Site 1, clean up the client
...
GRANT EXECUTE ON insert_ligne TO site1_user;
GRANT EXECUTE ON delete_ligne TO site1_user;
GRANT EXECUTE ON update_ligne TO site1_user;